...
public class NdcgMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HashMap<String, Map<String, Double>> relevScores = new HashMap<>();

        //query -> ndcg score
        HashMap<String, Double> queryNdcg = new HashMap<>();
        ...
        try {
            ...
            for (String curr : queryRankings.keySet()) {
                ...
                for (Pair<String, Document> urlDoc: queryRankings.get(curr)) {
                    Double rating = relevScores.get(curr).get(urlDoc.getKey());
                    Document document = urlDoc.getValue();
                    String urlString =
                            "  url: " + document.url + "\n" +
